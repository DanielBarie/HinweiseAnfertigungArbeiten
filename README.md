...
- Sehen Sie sich die Prüfungsordnung / Eigenständigkeitserklärung der Hochschule an.
...
# Eigene Leistung
- Dinge, die ich im Internet oder sonstwo nachlesen kann sind für Ihre Arbeit nicht wichtig. 70% der Seiten für Wiedergabe bekannter Sachverhalte und 30% für die eigene Leistung sind nicht ausreichend (durchgefallen!). Andersrum (70% eigene Leistung und 30% Einleitung/Schluss) ist es angemessen.  
...
- "Das sind doch Sachen, die ich einfach so weiß. Muss ich die belegen?". Klar, ich weiß auch, dass die Erde eine Scheibe ist. So wie der halbe SHK eben. Nur belegen kann ich es nicht. Und da haben wir das Problem. Also suchen Sie nach fundierten Quellen für Ihre Aussagen!
- Quellenarbeit erfordert die Angabe von Fundstellen (genaue Seitenzahl). "Aber ich habe doch Webseiten zitiert, da gibt es keine Seitenzahlen...": Dann machen Sie halt von Ihrem Kopf Gebrauch und überlegen sich was. Zum Beispiel einen PDF-Ausdruck der Webseite, in diesem können Sie direkt Hyperlinks setzen. Elektronisch beigelegt sind diese direkt aus der Arbeit zugänglich. Komfortabler geht's für den Leser kaum. Schon wieder ein Bienchen gesammelt.
